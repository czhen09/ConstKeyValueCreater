...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        ...
        [[NSUserDefaults standardUserDefaults] setObject:@"" forKey:@"hKeyConstString"];
        [[NSUserDefaults standardUserDefaults] setObject:@"" forKey:@"mKeyValueConstString"];
    ...
    if ([result isKindOfClass:[NSDictionary class]]) {
        ...
        if (![ESJsonFormatSetting defaultSetting].outputToFiles) {
            ...
            [self.dialog setDataWithMsg:msg defaultClassName:ESRootClassName enter:^(NSString *className) {
                ...
                [[NSUserDefaults standardUserDefaults] setObject:className forKey:@"preClassName"];
                ...
                if (weakSelf.isSwift) {
                    ...
                    weakSelf.hLabel.stringValue = [NSString stringWithFormat:@"%@PropertyListKeys.h",className];
                    weakSelf.mLabel.stringValue  = [NSString stringWithFormat:@"%@PropertyListKeys.m",className];
...
//            [NSApp runModalForWindow:[dialog window]];
            ...
            if ([obj isKindOfClass:[NSDictionary class]]) {
                ESClassInfo *childClassInfo = [[ESClassInfo alloc] initWithClassNameKey:key ClassName:@"" classDic:obj];
                ...
                if (array.firstObject) {
                    ...
                    //May be 'NSString'，will crash
                    if ([obj isKindOfClass:[NSDictionary class]]) {
                        ESClassInfo *childClassInfo = [[ESClassInfo alloc] initWithClassNameKey:key ClassName:@"" classDic:(NSDictionary *)obj];
                        [self dealPropertyNameWithClassInfo:childClassInfo];
